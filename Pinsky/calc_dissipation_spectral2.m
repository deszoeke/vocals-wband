...
R_2cond=2;
% R_2cond=1; % standard threshold from HS1074
                ...
                if length(ii10)>=di/4 % skip to next iteration if window too small
                    ...
                    if ~isempty(ik) && ik<100 % there 10 min data for cloud top
                        ...
                        if sum(~isn)>di/4
                            ...
                            [Sthresh, Snoise, knoise]=HildebrandSekhon2(S,R_2cond);
...
%% save data
save cloudtopturb2.mat ydayw10 F spec epsilon sigv2 count knoisetop Snoisetop Sthreshtop
% vertically-resolved data
save radarturb2.mat ydayw10 F speck epsilonk sigv2k countk knoisek Snoisek Sthreshk
